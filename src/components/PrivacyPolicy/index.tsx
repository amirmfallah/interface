...
const EXTERNAL_APIS = [
  {
    name: 'Auto Router',
    description: <Trans>The app fetches the optimal trade route from a ETHBridge Labs server.</Trans>,
  },
  {
    name: 'Infura',
              ...
              <RowBetween>
                <AutoRow gap="4px">
                  ...
                  <ThemedText.Main fontSize={14} color={'primaryText1'}>
                    <Trans>ETHBridge Labs&apos; Terms of Service</Trans>
                  </ThemedText.Main>
                </AutoRow>
